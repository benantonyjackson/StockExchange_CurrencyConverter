...
public class StockBrokeringWebService {
    ...
    public String fetchAllCompanyData() {
        int repsoneCode = 0;
        String idek = "";
    ...
    public String genorateRandomCompanyData()
    {
        ...
        try {            
            ...
            File file = new File("company_data.xml");
    ...
    public String getAllCompanyData() {
        try {
            if (!(new File("company_data.xml").exists()))
            {
                genorateRandomCompanyData();
            }
            
            return new String(Files.readAllBytes(Paths.get("company_data.xml")));
